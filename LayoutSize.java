 ...
 * @author SHASHANK
 */
public class LayoutSize extends javax.swing.JFrame {

    /**
     * Creates new form LayoutSize
     */
    public LayoutSize() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Micromouse");

        jLabel2.setText("Enter the number of rows");

        jLabel3.setText("Enter the number of columns");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LayoutSize.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
